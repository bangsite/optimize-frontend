                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-start justify-start gap-4 w-full">
                                            <div
                                                className="relative flex items-center justify-center w-[130px] aspect-square h-auto rounded-lg">
                                                <Image
                                                    src={p.image}
                                                    alt={p.title}
                                                    fill
                                        ...
                                        <div className="flex mt-14 items-center gap-3">
                                            <div
                                                className="relative flex items-center justify-center w-[60px] aspect-square h-auto rounded-full">
                                                <Image
                                                    src={p.avatar}
                                                    alt={p.title}
                                                    fill
